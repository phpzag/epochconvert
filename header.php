<header>
    <div class="header-container">
      <!-- Logo -->
      <div class="logo">
		<a href="https://www.epochconvert.com" aria-label="online epoch converter">
        <svg fill="#000000" width="80" version="1.1" id="svg" viewBox="0 0 297 297">	
		<g>
	  ...
	  <div class="logoText">
		<h1><a href="https://www.epochconvert.com" aria-label="online epoch converter">Epoch Convert</a></h1>
	  </div> 
			...
			<div class="language-menu" id="language-menu">
				...
				<div data-lang="pt-br"><span class="fi fi-br"></span>Português (Brasil)</div>
				<div data-lang="zh-cn"><span class="fi fi-cn"></span>中文（简体）</div>
				<div data-lang="pl"><span class="fi fi-pl"></span>Polski</div>
				<div data-lang="it"><span class="fi fi-it"></span>Italiano</div>
				<div data-lang="ja"><span class="fi fi-jp"></span>日本語</div>
				<div data-lang="sv"><span class="fi fi-se"></span>Svenska</div>
				<div data-lang="ar"><span class="fi fi-sa"></span>العربية</div>
				<div data-lang="fil"><span class="fi fi-ph"></span>Filipino</div>
				<div data-lang="ru"><span class="fi fi-ru"></span>Русский</div>
			</div>
		</div>
      <div class="hamburger">
        <span></span>
